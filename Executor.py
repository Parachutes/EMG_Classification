...
Utility.collect_data_with_windowing_per_channel(directory_cnn_windowing, data_training_window_cnn, labels_training_window_cnn, ["S1", "S2", "S3"], ["1","2"])
Utility.collect_testing_data_with_windowing_per_channel(directory_cnn_windowing, data_testing_window_cnn, labels_testing_window_cnn, ["S1", "S2", "S3"], ["3"])
