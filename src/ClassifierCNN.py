...
class ClassifierCNN:
    ...
    def train_the_model(self):
        ...
        model.add(keras.layers.Dense(150, activation='tanh', kernel_regularizer=self.regularizer, bias_regularizer=self.regularizer, activity_regularizer=self.regularizer))
        model.add(keras.layers.Dropout(0.4))
