...
Utility.collect_data_with_windowing(path_dataset, x_train, y_train, ["S1", "S2", "S3"], ["1", "2"])
Utility.collect_testing_data_with_windowing(path_dataset, x_test, y_test, ["S1", "S2", "S3"], ["3"])
