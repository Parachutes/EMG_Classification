...
class ClassifierCNN:
    ...
    def train_the_model(self):
        ...
        model.add(keras.layers.Conv3D(filters=5, kernel_size=(5,5,3), activation=keras.layers.LeakyReLU(alpha=0.3), input_shape=(100,100,8,1), kernel_regularizer=self.regularizer, bias_regularizer=self.regularizer))
        ...
        model.add(keras.layers.Conv3D(filters=3, kernel_size=(4,4,3), activation=keras.layers.LeakyReLU(alpha=0.3), kernel_regularizer=self.regularizer, bias_regularizer=self.regularizer))
